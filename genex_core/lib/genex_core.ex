defmodule GenexCore do
  ...
  alias Jason
  alias GenexCore.Credentials
  alias GenexCore.Diceware

  @encryption Application.get_env(:genex_core, :encryption_module)
  @random Application.get_env(:genex_core, :random_number_module)
  ...
  defp validate_unique(%GenexCore.Credentials{account: account, username: username, password: _}, current) do
    current
    |> Enum.find(fn x ->
