defmodule Genex.Core.Credentials do
  ...
  def new(%{"account" => account, "username" => username, "password" => password}) do
    %Credentials{account: account, username: username, password: password, created_at: DateTime.utc_now()}
  end

  def new(%{"account" => account, "username" => username, "encrypted_password" => password}) do
    %Credentials{account: account, username: username, encrypted_password: password, created_at: DateTime.utc_now()}
  end
 
  def new(%{"account" => account, "username" => username, "encrypted_password" => password, "created_at" => created}) do
    %Credentials{account: account, username: username, encrypted_password: password, created_at: created}
  end
